...
class SpacesControllerTest < ActionController::TestCase
  ...
  test "should create space" do
    assert_difference('Space.count') do
      post :create, space: { category_id: @space.category_id, height: @space.height, location: @space.location, width: @space.width }
    end
  ...
  test "should update space" do
    put :update, id: @space, space: { category_id: @space.category_id, height: @space.height, location: @space.location, width: @space.width }
    assert_redirected_to space_path(assigns(:space))
  end
