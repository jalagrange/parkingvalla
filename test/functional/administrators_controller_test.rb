...
class AdministratorsControllerTest < ActionController::TestCase
  ...
  test "should create administrator" do
    assert_difference('Administrator.count') do
      post :create, administrator: { address: @administrator.address, name: @administrator.name, phone: @administrator.phone, rif: @administrator.rif }
    end
  ...
  test "should update administrator" do
    put :update, id: @administrator, administrator: { address: @administrator.address, name: @administrator.name, phone: @administrator.phone, rif: @administrator.rif }
    assert_redirected_to administrator_path(assigns(:administrator))
  end
